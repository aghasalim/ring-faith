...
the prose around them were typed by hand, and every published figure is
recomputed from the raw tables by independent implementations in `verify/`, with
CI failing the build if any of them disagree.
